...
const SubtitleScreen = () => {
  const [subtitles, setSubtitles] = useState(
    "tdsadog dasf asfaf dagag fdga s/397045 5/how-to-make- the-overflow- css-proper ty-work-w ith-hidden-as-value"
  );
  ...
  return (
    ...
    >
      ...
      {sentences &&
        sentences.length > 0 &&
        sentences.map((s) => (
          <Text fontSize={16} p={1}>
            {s}
          </Text>
        ))}
      <div
        style={{ float: "left", clear: "both", marginTop: "100px" }}
        ref={messagesEndRef}
      ></div>
    </Box>
  );
